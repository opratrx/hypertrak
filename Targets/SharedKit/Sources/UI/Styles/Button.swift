...
public struct CTAButtonStyle: ButtonStyle {
	...
	public func makeBody(configuration: Configuration) -> some View {
		configuration.label
			...
			//			.background((configuration.role == .destructive || configuration.role == .cancel) ? Color.red.gradient : Color.accentColor.gradient) // Eh? Might look good. I'll leave it up to you to decide.
